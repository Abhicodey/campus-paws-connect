...
const LeaderboardCard = ({ rank, name, points, avatar }: LeaderboardCardProps) => {
  const isTop3 = rank <= 3;
  const rankColors = {
  ...
  return (
    <div
      className={`card-warm p-4 flex items-center gap-4 transition-all duration-200 ${
        isTop3 ? "border-2 shadow-warm" : ""
