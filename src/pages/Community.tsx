...
export default function Community() {
    return (
        <Page>
            <header className="bg-brand pt-8 pb-16 px-6 h-48 rounded-3xl relative z-0 mb-8 shadow-lg">
            ...
            <div className="max-w-md mx-auto px-6 space-y-6 relative z-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:space-y-0 md:max-w-none -mt-20">

                {/* 1. Support Campus Dogs */}
                <div className="max-w-xl w-full">
                    <Card className="border-none shadow-lg overflow-hidden h-full bg-card">
                        <div className="bg-gradient-to-r from-primary/20 to-primary/5 h-2" />
                        ...
                        <CardContent className="space-y-4">
                            ...
                            <p className="text-[10px] text-muted-foreground text-center bg-muted p-2 rounded border border-border">
                ...
                <div className="max-w-xl w-full">
                    <Card className="border-none shadow-md h-full bg-card">
                        <CardHeader className="pb-3">
                            <CardTitle className="flex gap-2 items-center text-xl text-pink-500">
                        ...
                        <CardContent className="space-y-4">
                            ...
                            <div className="grid grid-cols-2 gap-2 text-xs font-medium text-foreground/70">
                                <div className="bg-pink-500/10 text-pink-600 dark:text-pink-400 p-2 rounded text-center">Sponsor Day Food</div>
                                <div className="bg-pink-500/10 text-pink-600 dark:text-pink-400 p-2 rounded text-center">Feed Personally</div>
                                <div className="bg-pink-500/10 text-pink-600 dark:text-pink-400 p-2 rounded text-center">Donate Treats</div>
                                <div className="bg-pink-500/10 text-pink-600 dark:text-pink-400 p-2 rounded text-center">Sponsor Vax</div>
                            </div>
                            <div className="pt-2 border-t border-dashed border-border">
                                <p className="text-sm font-semibold mb-2 text-foreground">Plan My Celebration</p>
                                <a
                                    href={`mailto:${OFFICIAL.email}?subject=Birthday Celebration with CampusPaws`}
                                    className="flex items-center justify-center gap-2 w-full border-2 border-pink-500/20 bg-pink-500/5 text-pink-600 dark:text-pink-400 hover:bg-pink-500/10 py-2 rounded-lg font-medium transition-colors"
                                >
                                    Contact Team
                                </a>
                ...
                <div className="max-w-xl w-full">
                    <Card className="border-none shadow-md h-full bg-card">
                        <CardHeader className="pb-3">
                            <CardTitle className="flex gap-2 items-center text-xl text-indigo-500">
                        ...
                        <CardContent className="space-y-4">
                            ...
                            <ul className="text-xs space-y-2 text-muted-foreground bg-indigo-500/5 p-3 rounded-lg border border-indigo-500/10">
                            ...
                            <Button
                                variant="outline"
                                className="w-full border-indigo-500/20 text-indigo-600 dark:text-indigo-400 hover:bg-indigo-500/5"
                ...
                <div className="pt-4 md:col-span-2 lg:col-span-3">
                    ...
                    <div className="bg-card rounded-xl p-5 shadow-sm border border-border space-y-4">
                        ...
                        <div className="mt-4 bg-red-500/5 border border-red-500/20 rounded-lg p-3 flex gap-3 items-center">
                            <Ambulance className="w-5 h-5 text-red-600 dark:text-red-400" />
                            <div className="flex-1">
                                <p className="text-xs font-bold text-red-800 dark:text-red-300 uppercase">Emergency</p>
                                <p className="text-xs text-red-700 dark:text-red-400">Report injured/sick dogs using the <Link to="/report/dog" className="underline font-medium">Report Dog</Link> feature.</p>
                            </div>
                        </div>
                    </div>
                </div>
