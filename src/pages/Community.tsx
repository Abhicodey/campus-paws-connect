...
export default function Community() {
    return (
        <div className="min-h-screen bg-background pb-24">
            <header className="bg-primary pt-8 pb-16 px-6 h-48 rounded-b-3xl relative z-0 mb-8">
            ...
            <div className="max-w-md mx-auto px-6 -mt-20 space-y-6 relative z-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:space-y-0 md:max-w-5xl">
